...
import "./About.css";
import Header from "../Home/Headericon";
import saman from "../statics/png/saman.png";
import map from "../statics/png/map.png";
  ...
  return (
    <div className="container-About">
      ...
      <div className="title-blue-header">
        <h1 className="title-blue-header-text">درباره ما</h1>
      </div>
